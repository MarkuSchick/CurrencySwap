...
def _apply_return(euro_deposits, usd_deposits, return_on_euro_deposits, return_on_usd_deposits):
...
def _get_collateral_value(euro_deposits, usd_deposits, return_on_euro_deposits, return_on_usd_deposits, exchange_rate):
    euro_deposits, usd_deposits = _apply_return(euro_deposits, usd_deposits, return_on_euro_deposits, return_on_usd_deposits)
...
def _get_payout_factor(exchange_rate, start_exchange_rate, leverage):
    EURlong_payout_fac = 1 +  (exchange_rate - start_exchange_rate)/start_exchange_rate * leverage 
    EURshort_payout_fac = 2 - EURlong_payout_fac
    return EURlong_payout_fac, EURshort_payout_fac


def payout_currency_swap(final_exchange_rate, start_exchange_rate, USD_asset_allocation, leverage, return_on_euro_deposits = 0.0, return_on_usd_deposits = 0.0):
    """
    ...
    Returns:
        [EURlong_payout, EURshort_payout]: Payout of 1 unit of a EURlong, EURshort certificate given economic conditions 
    """
    # allocate assets
    ...
    underlying_collateral = _get_collateral_value(euro_deposits, usd_deposits, exchange_rate, )
    
    # get payout factor
    EURlong_payout_fac, EURshort_payout_fac = _get_payout_factor(final_exchange_rate, start_exchange_rate, leverage)
